...
//
// Firestore 기반 구독 상태 관리.
// kSubscriptionEnabled = false 이면 모든 로직이 no-op 으로 동작.
//
// ── 연동 구조 ────────────────────────────────────────────────────────────────
// [현재]  Firebase 콘솔에서 users/{uid}.subscriptionTier 직접 수정 → 앱 반영
// [출시]  Play Store 결제 → Cloud Function → users/{uid}.subscriptionTier 업데이트
// ──────────────────────────────────────────────────────────────────────────────
...
class SubscriptionService {
  ...
  // ─────────────────────────────────────────
  // 내부: Firestore에서 내 구독 tier 읽기
  // users/{uid}.subscriptionTier: "free" | "classic" | "pro" | "business"
  // ─────────────────────────────────────────
